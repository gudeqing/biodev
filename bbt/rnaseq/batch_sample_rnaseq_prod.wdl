...
task star_alignment{
    ...
    runtime {
        docker: "registry-xdp-v3-yifang.xdp.basebit.me/basebitai/starfusion:1.10.0"
        memory: memory
        cpu: cpu
        disks: disks
        time_minutes: time_minutes
...
task rnaseqc{
    ...
    runtime {
        docker: "registry-xdp-v3-yifang.xdp.basebit.me/basebitai/rnaseqc:2.4.2"
        memory: memory
        cpu: cpu
        disks: disks
        time_minutes: time_minutes
...
#        Directory indexDir
    ...
    runtime {
        docker: "registry-xdp-v3-yifang.xdp.basebit.me/basebitai/rsem:1.3.3"
        memory: memory
        cpu: cpu
        disks: disks
        time_minutes: time_minutes
...
task geneBodyCoverage{
    ...
    runtime {
        docker: "registry-xdp-v3-yifang.xdp.basebit.me/basebitai/rseqc:4.0.0"
        memory: memory
        cpu: cpu
        disks: disks
        time_minutes: time_minutes
