...
class QuantExpToolbox(object):
    ...
    def build_index(self, kmer=31):
        # if os.path.exists('{}/transcripts_index '.format(self.output)):
        #     if not len(os.listdir('{}/transcripts_index '.format(self.output))) >= 2:
        #         pass
        #     else:
        #         print('Index files seems to be existed in transcripts_index, we will not build index again.')
        #         return
